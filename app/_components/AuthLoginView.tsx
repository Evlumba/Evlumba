...
export default function AuthLoginView({
  ...
  }, [isOAuthReturn, minimal, nextPath, router]);
  ...
  if (minimal) {
    return (
      <section className="flex min-h-screen w-full items-center justify-center bg-white px-4">
        <div className="w-full max-w-md rounded-2xl border border-black/10 bg-white p-6 shadow-[0_20px_55px_-40px_rgba(0,0,0,0.35)]">
