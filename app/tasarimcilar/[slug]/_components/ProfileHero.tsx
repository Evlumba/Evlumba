        ...
        <div className="relative h-56 sm:h-64 md:h-80 w-full overflow-hidden">
          {coverUrl ? (
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-white">
              <img src="/web_icon2.png" alt="Evlumba" className="h-16 w-auto opacity-90" />
              <span className="mt-3 text-xs font-medium tracking-widest text-slate-400 uppercase">Yaşam alanınızı birlikte tasarlayalım</span>
            </div>
          )}
